-- big free trials experiment query
...
--                              rf.sso_user_id is not null then 1 end)              as refunds,
           max(case
                   when d.subscription_start_date :: date between '2021-10-27' and '2021-11-18' and
                        ...
                        f.sso_key is not null then 1 end)                   as failed_payments,
...
--                             and rf.sso_user_id isnull then 1 end)                as minus_refunds,
           ...
           sum(case when license = 'project' and q > 0 then q end)          as project_downloads,
           sum(case when license = 'download' and q > 0 then q end)         as downloads,
